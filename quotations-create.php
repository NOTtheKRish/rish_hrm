                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4"><!-- Main Card Start -->
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                            <h5 class="m-0 font-weight-bold text-primary">Create New Quotation</h5>
                            ...
                            <form action="quotations.php" class="invoice-form" id="invoice-form" method="POST" role="form" novalidate="">
                                <div class="form-row">
                                    <div class="form-group col-md-3">Company ID
                                        <div class="form-input">
                                            <select name="com_id" class="form-control" required aria-required="true">
                                                ...
                                                ?>
                                                <?php echo'<option value="'.$row['id'].'">E-'.$row['com_id'].' - '.$row['name'].'</option>';?>
                                                <?php }}?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">Quotation Date
                                        <div class="form-input">
                                            <input class="form-control" type="date" name="quot_date">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-3">Valid Upto
                                        <div class="form-input">
                                            <input class="form-control" type="date" name="quot_end">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-responsive">
                                    <thead>
                                        <!-- <tr class="bg-light text-dark">
                                            ...
                                            <td>GST Tax (in %)</td>
                                            <td>Total</td>
                                            <td><span style="display:none;">taxTot</span></td>
                                        </tr> -->
                                        <tr class="bg-light text-dark">
                                            <td><input id="checkAll" class="form-control" type="checkbox"></td>
                                    ...
                                    <tbody id="quotationItem">
                                        <!-- <tr class="bg-secondary">
                                            <td></td>
                                            <td><select class="form-control col-md-12 item" id="item_1" style="width: 250px;"><?php getItems($conn,$_SESSION['userRel']);?></select></td>
                                            <td><textarea class="form-control description" id="description_1" cols="30" rows="1"></textarea></td>
