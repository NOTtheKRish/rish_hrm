            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Vacancy Details</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4"><!-- Main Card Start -->
                        ...
                        <div class="card-body">
                            <!-- Delete Video Start -->
                            <?php echo'<form action="vacancy.php" method="POST">';?>
                                <div class="form-row d-sm-flex">
                                    <div class="form-group">Are you sure to delete this Vacancy??</div>
