            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4"><!-- Main Card Start -->
                        ...
                        <div class="card-body">
                            <!-- Delete Video Start -->
                            <?php echo'<form action="call-list.php" method="POST">';?>
                                <div class="form-row d-sm-flex">
                                    <div class="form-group">Are you sure to delete this entry??</div>
                                    <?php echo'<input type="hidden" name="call_id" value="'.$_GET['id'].'">'?>
