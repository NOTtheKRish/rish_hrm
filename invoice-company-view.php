            ...
            <div class="text-dark">
                <div class="form-row col-md-12">
                    ...
                    <div class="form-group col-md-4">
                        <div class="col-md-11">
                            ...
                            <?php
                                $sql="SELECT * FROM com_invoice WHERE id='".$inv_id."'";
                                $result=mysqli_query($conn,$sql);
                                if(mysqli_num_rows($result)>0){
                                while($rows=mysqli_fetch_array($result)){
                                    $invId=$rows['inv_id'];
                                    ...
                                    // $inv_nxt_yr=date('Y',strtotime('+1 year', strtotime($inv_yr)));
                            ...
                            <span class="mr-2"><?php echo $com['email'];?></span><br>
                            <span>GSTIN: <?php echo $com['gst_no'];?></span><br>
                    ...
                    <div class="form-group col-md-4">
                        <div class="col-md-12">
                            <div class="form-row justify-content-end">
                                <div class="col-md-10">
                                    <div class="text-dark" style="border-radius:5px;">
                                        <?php echo'<h6 class="card-title" style="border:2px solid #5A5C69;border-radius:5px;text-align:center;padding:10px;">Invoice No : <strong>'.$inv_year.'-'.$invId.'</strong></h6>';?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row justify-content-end">
                                <div class="col-md-10">
                                    <div class="text-dark" style="border-radius:5px;">
                                        <?php echo'<h6 class="card-title" style="border:2px solid #5A5C69;border-radius:5px;text-align:center;padding:10px;">Amount Due : <strong>&#x20B9;'.number_format($total_pay,2).'</strong></h6>';?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row justify-content-end">
                                <div class="col-md-10">
                                    <div class="text-dark" style="border-radius:5px;">
                                        <?php echo'<h6 class="card-title" style="border:2px solid #5A5C69;border-radius:5px;text-align:center;padding:10px;">Invoice Date : <strong>'.$inv_date.'</strong></h6>';?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-row col-md-12 mb-3">
                    <table class="table text-dark table-bordered">
                        ...
                        <tbody>
                            <?php
                                $sql="SELECT * FROM com_invoice_item WHERE inv_id='".$inv_id."'";
                ...
                <?php
                    ...
                    $old_balance=0;
                    $new_balance=0;
                    $ri="SELECT total_pending FROM com_invoice WHERE com_id='".$com_id."' AND inv_id !='".$invId."' AND entry_by='".$_SESSION['userRel']."'";
                ...
                <table class="table text-dark table-bordered">
                    ...
                    <tr class="text-center" style="font-weight:bold;width:1000px;">
                        <td>
                            <span>Received (For <?php echo $com_name;?>)</span><br><br><br><br><br>
