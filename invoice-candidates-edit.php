                    ...
                    <div class="card shadow mb-4"><!-- Main Card Start -->
                        ...
                        <div class="card-body">                            
                            ...
                            <form action="invoice-candidates.php" class="invoice-form" id="invoice-form" method="POST" role="form" novalidate="">
                                <?php
                                    $i = "SELECT * FROM can_invoice WHERE id='".$invId."'";
                                            ...
                                            <select name="can_id" class="form-control">
                                                ...
                                                <?php
                                                    ...
                                                    foreach($result as $can){
                                                        if($invoice['can_id']==$can['id']){
                                                            echo'<option value="'.$can['id'].'" selected>C-'.$can['can_id'].' - '.$can['name'].'</option>'; 
                                                        }else{
                                                            echo'<option value="'.$can['id'].'">C-'.$can['can_id'].' - '.$can['name'].'</option>'; 
                                                        }
                                                    }
                                                ?>
                                            </select>
                                ...
                                <table class="table table-responsive" id="invoiceItem">
                                    ...
                                    <tbody id="invoiceItem">
                                        <?php
                                            $it = "SELECT * FROM can_invoice_item WHERE inv_id='".$invId."'";
