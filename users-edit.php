                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <?php echo'<input class="form-control" hidden type="text" name="userid" value="'.$row['id'].'">'?>
                                        </div>
                                        <div class="form-group col-md-8">
                                        ...
                                        <div class="form-group col-md-8">
                                            ...
                                            <input class="form-control" type="password" name="password" value="" required autocomplete="off">
                                        </div>
                                        <div class="form-group col-auto">
                                            <button class="btn btn-primary" name="update" type="submit"><i class="fas fa-save mr-2"></i>Update</button>
                                            <a class="btn btn-primary" href="users.php"><i class="fas fa-arrow-left mr-2"></i>Back</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
