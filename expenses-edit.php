                            ...
                            <form action="expenses-all.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <?php echo'<input type="hidden" name="previous" value="'.$_SERVER['HTTP_REFERER'].'">'?>
                                        ...
                                        <div class="col-sm-2">
                                            <select name="spend_for" class="form-control">
                                                <?php echo'<option value="'.$row['spend_for'].'">'.$row['spend_for'].'</option>';?>
                                                <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <?php echo'<input type="date" class="form-control" name="date" value="'.$row['date'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="name" class="col-sm-4 col-form-label">Name</label>
                                        <div class="col-sm-3">
                                            <?php echo'<input type="text" class="form-control" hidden name="expense_id" value="'.$row['id'].'">';?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <?php echo'<textarea class="form-control" name="description">'.$row['description'].'</textarea>';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="gst_no" class="col-sm-4 col-form-label">GST Number</label>
                                        <div class="col-sm-3">
                                            <?php echo'<input type="text" class="form-control" name="gst_no" value="'.$row['gst_no'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="taxable_amt" class="col-sm-4 col-form-label">Taxable Amount</label>
                                        <div class="col-sm-2">
                                            <?php echo'<input type="text" class="form-control" name="taxable_amt" value="'.$row['taxable_amt'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cgst" class="col-sm-4 col-form-label">CGST</label>
                                        <div class="col-sm-2">
                                            <?php echo'<input type="text" class="form-control" name="cgst" value="'.$row['cgst'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="sgst" class="col-sm-4 col-form-label">SGST</label>
                                        <div class="col-sm-2">
                                            <?php echo'<input type="text" class="form-control" name="sgst" value="'.$row['sgst'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="total_paid" class="col-sm-4 col-form-label">Total Paid Amount</label>
                                        <div class="col-sm-2">
                                            <?php echo'<input type="text" class="form-control" name="total_paid" value="'.$row['total_paid'].'">';?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <button class="btn btn-primary" name="update" type="submit"><i class="fas fa-plus mr-2"></i>Update</button>
                                    </div>
                                </div>
                            </form>
                            <?php }?>
