                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4"><!-- Main Card Start -->
                        <div class="card-header py-3 d-sm-flex align-items-center justify-content-between mb-4">
                            <h5 class="m-0 font-weight-bold text-primary">Delete Candidate Payment Details</h5>
                        ...
                        <div class="card-body">
                            <!-- Delete Video Start -->
                            <?php echo'<form action="payments-candidates.php" method="POST">';?>
                                <div class="form-row d-sm-flex">
                                    <div class="form-group">Are you sure to delete this Payment Data??</div>
                                    <?php echo'<input type="hidden" name="payId" value="'.$_GET['id'].'">'?>
